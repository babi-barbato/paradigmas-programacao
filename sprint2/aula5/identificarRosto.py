...
pathImg = r'C:\Users\babib\OneDrive\Documentos\paradigmas-programacao\sprint2\aula5\palmeiras.jpg'
...
face_recon = face_frontal.detectMultiScale(imagemGray, scaleFactor = 1.5, minNeighbors = 1, minSize=(80,80))

# ()
print('Faces Encontradas: ', len(face_recon))
